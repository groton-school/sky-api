...
class List_ extends BaseEndpoint
{
    ...
    public function list_(array $params): CurrencyListCollection
    {
        ...
        return new CurrencyListCollection($this->send("get", [], array_filter($params, fn($key) => in_array($key, ['includeinactive','limit','session_key','infinity_session','more_rows_range_key','start_row_index']), ARRAY_FILTER_USE_KEY)));
    }
}
