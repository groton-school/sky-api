 ...
 * @property \Blackbaud\SKY\Altru\Administration\Components\CurrencyListSummary[]
 ...
 * @api
 */
class CurrencyListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Administration\Components\CurrencyListSummary[]",
