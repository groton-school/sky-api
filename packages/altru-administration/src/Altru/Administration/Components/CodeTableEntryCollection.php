 ...
 * @property \Blackbaud\SKY\Altru\Administration\Components\CodeTableEntry[]
 *   $value The set of items included in the response. This may be a subset of
 *   the items in the collection.
 *
 * @api
 */
class CodeTableEntryCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Administration\Components\CodeTableEntry[]",
    ];
}
