 ...
 * @property \Blackbaud\SKY\Altru\Administration\Components\CodeTableListSummary[]
 ...
 * @api
 */
class CodeTableListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Administration\Components\CodeTableListSummary[]",
