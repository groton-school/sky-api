...
namespace Blackbaud\SKY\Altru\Analysis\Components\ApiCollection;
 ...
 * @property \Blackbaud\SKY\Altru\Analysis\Components\AdHocQueryRead[] $value
 *   The set of items included in the response. This may be a subset of the
...
class AdHocQueryRead extends BaseComponent
{
    ...
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Analysis\Components\AdHocQueryRead[]",
    ];
}
