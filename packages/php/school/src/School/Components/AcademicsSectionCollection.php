 ...
 *   page of results
 * @property ?\Blackbaud\SKY\School\Components\AcademicsSection[] $value The
 *   set of items included in the response. This may be a subset of the items in
 *   the collection
 *
 * @api
 */
class AcademicsSectionCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "next_link" => "string",
        "value" => "\Blackbaud\SKY\School\Components\AcademicsSection[]",
    ];
}
