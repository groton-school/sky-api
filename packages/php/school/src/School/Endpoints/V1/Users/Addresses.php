...
class Addresses extends BaseEndpoint
{
    ...
    public function searchByUserId(array $params): AddressReadCollection
    {
        ...
        return new AddressReadCollection($this->send("get", array_filter($params, fn($key) => in_array($key, ['user_id']), ARRAY_FILTER_USE_KEY), []));
    }
    ...
    public function patchOnUserIdAndAddressId(array $params, AddressPatch $requestBody): int
    {
        ...
        return $this->send("patch", array_filter($params, fn($key) => in_array($key, ['user_id','address_id']), ARRAY_FILTER_USE_KEY), [], $requestBody);
    }
    ...
    public function deleteByUserIdAndAddressIdAndAddressTypeId(array $params): mixed
    {
        ...
        return $this->send("delete", array_filter($params, fn($key) => in_array($key, ['user_id','address_id','address_type_id']), ARRAY_FILTER_USE_KEY), []);
    }
}
