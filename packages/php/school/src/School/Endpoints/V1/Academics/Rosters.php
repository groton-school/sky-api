...
class Rosters extends BaseEndpoint
{
    ...
    /**
     * Returns the academic rosters for a selected year. Uses current school
     * year by default.
     *
     ...
     *     - school_year: The ID or label of the school year.
     * Defaults to the current school year.
     *     - school_level: Format - int32. Limits rosters returned to school
     *   level specified.
     *     - section_ids: Limits rosters returned to sections specified.
     * Provide comma-delimited list of section\_id values.
     ...
     *   date provided.
     *  Use ISO-8601 date-time format: 2024-09-01T00:00:00-5:00.
     *
