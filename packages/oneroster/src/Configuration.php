...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sky.blackbaud.com/afe-rostr/ims/oneroster/v1p1';
    ...
    {
        $report  = 'PHP SDK (SKY\OneRoster) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1p1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.sky.blackbaud.com/afe-rostr/ims/oneroster/v1p1",
