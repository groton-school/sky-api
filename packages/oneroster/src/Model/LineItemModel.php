 ...
 */
class LineItemModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineItemModel';
    ...
    protected static $openAPITypes = [
        ...
        'category' => '\SKY\OneRoster\Model\GuidRefModel',
        'gradingPeriod' => '\SKY\OneRoster\Model\GuidRefModel',
    ...
    protected static $attributeMap = [
        ...
        'resultValueMin' => 'resultValueMin',
        'resultValueMax' => 'resultValueMax',
        'sourcedId' => 'sourcedId',
        'status' => 'status',
    ...
    protected static $setters = [
        ...
        'assignDate' => 'setAssignDate',
        'dueDate' => 'setDueDate',
        'class' => 'setClass',
        'category' => 'setCategory',
        'gradingPeriod' => 'setGradingPeriod',
        'resultValueMin' => 'setResultValueMin',
        'resultValueMax' => 'setResultValueMax',
    ...
    protected static $getters = [
        ...
        'resultValueMin' => 'getResultValueMin',
        'resultValueMax' => 'getResultValueMax',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('assignDate', $data ?? [], null);
        $this->setIfExists('dueDate', $data ?? [], null);
        $this->setIfExists('class', $data ?? [], null);
        $this->setIfExists('category', $data ?? [], null);
        $this->setIfExists('gradingPeriod', $data ?? [], null);
        $this->setIfExists('resultValueMin', $data ?? [], null);
        $this->setIfExists('resultValueMax', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['assignDate'];
    }

    /**
     * Sets assignDate
     *
     * @param \DateTime|null $assignDate assignDate
     *
     * @return self
     */
    public function setAssignDate($assignDate)
    {
        if (is_null($assignDate)) {
            array_push($this->openAPINullablesSetToNull, 'assignDate');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('assignDate', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['assignDate'] = $assignDate;
     ...
     * Sets category
     *
     * @param \SKY\OneRoster\Model\GuidRefModel|null $category category
     *
     * @return self
     */
     ...
     * @return \SKY\OneRoster\Model\GuidRefModel|null
     */
    public function getGradingPeriod()
    {
        return $this->container['gradingPeriod'];
    }

    /**
     * Sets gradingPeriod
     *
     * @param \SKY\OneRoster\Model\GuidRefModel|null $gradingPeriod gradingPeriod
     *
     * @return self
     */
    public function setGradingPeriod($gradingPeriod)
    {
        if (is_null($gradingPeriod)) {
            throw new \InvalidArgumentException('non-nullable gradingPeriod cannot be null');
        }
        $this->container['gradingPeriod'] = $gradingPeriod;
     ...
     * @return float|null
     */
    public function getResultValueMin()
    {
        return $this->container['resultValueMin'];
    }

    /**
     * Sets resultValueMin
     *
     * @param float|null $resultValueMin resultValueMin
     *
     * @return self
     */
    public function setResultValueMin($resultValueMin)
    {
        if (is_null($resultValueMin)) {
            array_push($this->openAPINullablesSetToNull, 'resultValueMin');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resultValueMin', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['resultValueMin'] = $resultValueMin;
     ...
     * @return float|null
     */
    public function getResultValueMax()
    {
        return $this->container['resultValueMax'];
    }

    /**
     * Sets resultValueMax
     *
     * @param float|null $resultValueMax resultValueMax
     *
     * @return self
     */
    public function setResultValueMax($resultValueMax)
    {
        if (is_null($resultValueMax)) {
            array_push($this->openAPINullablesSetToNull, 'resultValueMax');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resultValueMax', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['resultValueMax'] = $resultValueMax;
