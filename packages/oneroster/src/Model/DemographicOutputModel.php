...
/**
 * DemographicOutputModel Class Doc Comment
 *
 * @category Class
 * @package  SKY\OneRoster
 * @author   OpenAPI Generator team
 ...
 */
class DemographicOutputModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DemographicOutputModel';
    ...
    protected static $openAPITypes = [
        'demographic' => '\SKY\OneRoster\Model\ORDemographicModel',
    ];
    ...
    {
        $this->setIfExists('demographic', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['demographic'];
    }

    /**
     * Sets demographic
     *
     * @param \SKY\OneRoster\Model\ORDemographicModel|null $demographic demographic
     *
     * @return self
     */
    public function setDemographic($demographic)
    {
        if (is_null($demographic)) {
            throw new \InvalidArgumentException('non-nullable demographic cannot be null');
        }
        $this->container['demographic'] = $demographic;
