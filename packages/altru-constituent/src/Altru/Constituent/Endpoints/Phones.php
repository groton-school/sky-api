...
class Phones extends BaseEndpoint
{
    ...
    public function getByPhoneId(array $params): ConstituentPhone
    {
        ...
        return new ConstituentPhone($this->send("get", array_filter($params, fn($key) => in_array($key, ['phone_id']), ARRAY_FILTER_USE_KEY), []));
    }
    ...
    public function deleteByPhoneId(array $params): mixed
    {
        ...
        return $this->send("delete", array_filter($params, fn($key) => in_array($key, ['phone_id']), ARRAY_FILTER_USE_KEY), []);
    }
    ...
    public function patchOnPhoneId(array $params, EditConstituentPhone $requestBody): mixed
    {
        ...
        return $this->send("patch", array_filter($params, fn($key) => in_array($key, ['phone_id']), ARRAY_FILTER_USE_KEY), [], $requestBody);
    }
}
