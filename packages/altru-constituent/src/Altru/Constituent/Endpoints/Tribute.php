...
class Tribute extends BaseEndpoint
{
    ...
    public function getByRevenueTributeId(array $params): Components_Tribute
    {
        ...
        return new Components_Tribute($this->send("get", array_filter($params, fn($key) => in_array($key, ['revenue_tribute_id']), ARRAY_FILTER_USE_KEY), []));
    }
    ...
    public function patchOnRevenueTributeId(array $params, EditTribute $requestBody): mixed
    {
        ...
        return $this->send("patch", array_filter($params, fn($key) => in_array($key, ['revenue_tribute_id']), ARRAY_FILTER_USE_KEY), [], $requestBody);
    }
}
