...
use Blackbaud\SKY\Altru\Constituent\Components\Tribute as TributeDisambiguate;
...
class Tribute extends BaseEndpoint
{
     ...
     */
    public function postBy(NewTribute $requestBody): PostResponse
    {
     ...
     *   parameters are not defined
     */
    public function getByRevenueTributeId(array $params): Tribute
    {
        assert(isset($params['revenue_tribute_id']), new ArgumentException("Parameter `revenue_tribute_id` is required"));

        return new TributeDisambiguate($this->send("get", ["{revenue_tribute_id}" => $params['revenue_tribute_id']], []));
    }
     ...
     *   parameters are not defined
     */
    public function patchByRevenueTributeId(array $params, UpdateTribute $requestBody): void
    {
        assert(isset($params['revenue_tribute_id']), new ArgumentException("Parameter `revenue_tribute_id` is required"));
        assert(isset($params['requestBody']), new ArgumentException("Parameter `requestBody` is required"));
