...
class Addresses extends BaseEndpoint
{
    ...
    /**
     * This datalist returns all address contact information for a
     * constituent.
     *
    ...
    public function searchByConstituentId(array $params): ConstituentAddressListCollection
    {
        ...
        return new ConstituentAddressListCollection($this->send("get", ["constituent_id" => $params['constituent_id']], ["include_former" => $params['include_former'],
            "limit" => $params['limit']]));
    }
}
