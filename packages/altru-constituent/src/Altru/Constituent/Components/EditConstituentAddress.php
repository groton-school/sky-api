 ...
 *   API.
 * @property \Blackbaud\SKY\Altru\Constituent\Components\EditConstituentAddressZipLookupCountries[]
 *   $zip_lookup_countries Zip lookup countries.
 * @property \Blackbaud\SKY\Altru\Constituent\Components\EditConstituentAddressValidationCountries[]
 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\EditConstituentAddressMatchingHouseholdMembers[]
 ...
 * @api
 */
class EditConstituentAddress extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        ...
        "zip_lookup_countries" => "\Blackbaud\SKY\Altru\Constituent\Components\EditConstituentAddressZipLookupCountries[]",
        "validation_countries" => "\Blackbaud\SKY\Altru\Constituent\Components\EditConstituentAddressValidationCountries[]",
        ...
        "matching_household_members" => "\Blackbaud\SKY\Altru\Constituent\Components\EditConstituentAddressMatchingHouseholdMembers[]",
