 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\ConstituentListSummary[]
 ...
 * @api
 */
class ConstituentListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\ConstituentListSummary[]",
