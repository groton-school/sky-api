 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\EducationListSummary[]
 *   $value The set of items included in the response. This may be a subset of
 *   the items in the collection.
 *
 * @api
 */
class EducationListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\EducationListSummary[]",
    ];
}
