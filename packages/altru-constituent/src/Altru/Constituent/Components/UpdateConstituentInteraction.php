 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentInteractionParticipants[]
 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentInteractionSites[]
 *   $sites sites
 ...
 * @api
 */
class UpdateConstituentInteraction extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        ...
        "step" => "bool",
        "event_id" => "string",
        "participants" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentInteractionParticipants[]",
        "constituent_id" => "string",
        "constituent_name" => "string",
        "interaction_category" => "string",
        "interaction_subcategory" => "string",
        "sites" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentInteractionSites[]",
