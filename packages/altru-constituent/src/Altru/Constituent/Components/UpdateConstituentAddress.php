 ...
 *   API.
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentAddressZiplookupcountries[]
 *   $zip_lookup_countries zip\_lookup\_countries
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentAddressValidationcountries[]
 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentAddressMatchinghouseholdmembers[]
 ...
 *   YYYY-MM-DD. An example date: *2019-11-21*.
 * @property string $date_added The date added. Read-only in the SOAP API.Uses
 *   the format YYYY-MM-DD. An example date: *2019-11-21*.
 ...
 * @api
 */
class UpdateConstituentAddress extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        ...
        "zip_lookup_countries" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentAddressZiplookupcountries[]",
        "validation_countries" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentAddressValidationcountries[]",
        ...
        "matching_household_members" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateConstituentAddressMatchinghouseholdmembers[]",
