 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\ConstituentPhoneListSummary[]
 ...
 * @api
 */
class ConstituentPhoneListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\ConstituentPhoneListSummary[]",
