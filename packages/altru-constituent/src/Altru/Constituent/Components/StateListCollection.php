 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\StateListSummary[]
 ...
 * @api
 */
class StateListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\StateListSummary[]",
