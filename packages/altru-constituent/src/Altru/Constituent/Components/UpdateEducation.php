 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateEducationAffiliatedadditionalinformation[]
 *   $affiliated_additional_information affiliated\_additional\_information
 * @property \Blackbaud\SKY\Altru\Constituent\Components\UpdateEducationUnaffiliatedadditionalinformation[]
 ...
 * @api
 */
class UpdateEducation extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        ...
        "comment" => "string",
        "affiliated_additional_information" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateEducationAffiliatedadditionalinformation[]",
        "unaffiliated_additional_information" => "\Blackbaud\SKY\Altru\Constituent\Components\UpdateEducationUnaffiliatedadditionalinformation[]",
        "affiliated" => "bool",
