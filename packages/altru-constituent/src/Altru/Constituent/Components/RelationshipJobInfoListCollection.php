 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\RelationshipJobInfoListSummary[]
 *   $value The set of items included in the response. This may be a subset of
 *   the items in the collection.
 *
 * @api
 */
class RelationshipJobInfoListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\RelationshipJobInfoListSummary[]",
    ];
}
