 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\ConstituentEmailAddressListSummary[]
 ...
 * @api
 */
class ConstituentEmailAddressListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\ConstituentEmailAddressListSummary[]",
