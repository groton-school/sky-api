 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\ConstituentAttributeListSummary[]
 ...
 * @api
 */
class ConstituentAttributeListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\ConstituentAttributeListSummary[]",
