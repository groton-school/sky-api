 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\EditConstituentInteractionParticipants[]
 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\EditConstituentInteractionSites[]
 *   $sites Sites.
 ...
 * @api
 */
class EditConstituentInteraction extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        ...
        "step" => "bool",
        "event_id" => "string",
        "participants" => "\Blackbaud\SKY\Altru\Constituent\Components\EditConstituentInteractionParticipants[]",
        "constituent_id" => "string",
        "constituent_name" => "string",
        "interaction_category" => "string",
        "interaction_subcategory" => "string",
        "sites" => "\Blackbaud\SKY\Altru\Constituent\Components\EditConstituentInteractionSites[]",
