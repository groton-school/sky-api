 ...
 * @property \Blackbaud\SKY\Altru\Constituent\Components\ConstituentAppealListSummary[]
 ...
 * @api
 */
class ConstituentAppealListCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "value" => "\Blackbaud\SKY\Altru\Constituent\Components\ConstituentAppealListSummary[]",
