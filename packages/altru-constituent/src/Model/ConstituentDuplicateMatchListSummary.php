...
/**
 * ConstituentDuplicateMatchListSummary Class Doc Comment
 *
 * @category Class
 * @description ListConstituentDuplicateMatch
 * @package  SKY\Altru\Constituent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ConstituentDuplicateMatchListSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstituentDuplicateMatchListSummary';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('matchScore', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets matchScore
     *
     * @param int|null $matchScore The match score.
     *
     * @return self
     */
    public function setMatchScore($matchScore)
    {
        if (is_null($matchScore)) {
            throw new \InvalidArgumentException('non-nullable matchScore cannot be null');
        }
