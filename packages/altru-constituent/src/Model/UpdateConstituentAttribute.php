...
/**
 * UpdateConstituentAttribute Class Doc Comment
 *
 * @category Class
 * @description UpdateConstituentAttribute
 * @package  SKY\Altru\Constituent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateConstituentAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateConstituentAttribute';
    ...
    */
    ...
    public function setStringValue($stringValue)
    {
        ...
        if ((mb_strlen($stringValue) > 250)) {
            throw new \InvalidArgumentException('invalid length for $stringValue when calling UpdateConstituentAttribute., must be smaller than or equal to 250.');
        }
        if ((mb_strlen($stringValue) < 0)) {
            throw new \InvalidArgumentException('invalid length for $stringValue when calling UpdateConstituentAttribute., must be bigger than or equal to 0.');
        }
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 255)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling UpdateConstituentAttribute., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($comment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling UpdateConstituentAttribute., must be bigger than or equal to 0.');
        }
