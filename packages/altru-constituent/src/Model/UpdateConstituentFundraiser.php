...
/**
 * UpdateConstituentFundraiser Class Doc Comment
 *
 * @category Class
 * @description UpdateConstituentFundraiser
 * @package  SKY\Altru\Constituent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateConstituentFundraiser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateConstituentFundraiser';
    ...
    */
     ...
     * Sets dateFrom
     *
     * @param \DateTime|null $dateFrom The date from.Uses the format YYYY-MM-DD. An example date: <i>2019-11-21</i>.
     *
     * @return self
     */
     ...
     * Sets dateTo
     *
     * @param \DateTime|null $dateTo The date to.Uses the format YYYY-MM-DD. An example date: <i>2019-11-21</i>.
     *
     * @return self
     */
