...
/**
 * UpdateConstituentAddressValidationcountries Class Doc Comment
 *
 * @category Class
 * @description UpdateConstituentAddressValidationcountries
 * @package  SKY\Altru\Constituent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateConstituentAddressValidationcountries implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateConstituentAddressValidationcountries';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('browsable', $data ?? [], null);
    }
