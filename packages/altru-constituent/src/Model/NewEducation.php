...
/**
 * NewEducation Class Doc Comment
 *
 * @category Class
 * @description CreateEducation
 * @package  SKY\Altru\Constituent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NewEducation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NewEducation';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'affiliateDadditionalInformation' => '\SKY\Altru\Constituent\Model\NewEducationAffiliatedadditionalinformation[]',
        'unaffiliatedAdditionalInformation' => '\SKY\Altru\Constituent\Model\NewEducationUnaffiliatedadditionalinformation[]',
        'affiliated' => 'bool',
    ...
    protected static $attributeMap = [
        ...
        'comment' => 'comment',
        'affiliateDadditionalInformation' => 'affiliate_dadditional_information',
    ...
    */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling NewEducation., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($comment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling NewEducation., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \SKY\Altru\Constituent\Model\NewEducationAffiliatedadditionalinformation[]|null
     */
     ...
     *
     * @param \SKY\Altru\Constituent\Model\NewEducationAffiliatedadditionalinformation[]|null $affiliateDadditionalInformation affiliate_dadditional_information
     *
     * @return self
     */
     ...
     *
     * @return \SKY\Altru\Constituent\Model\NewEducationUnaffiliatedadditionalinformation[]|null
     */
     ...
     *
     * @param \SKY\Altru\Constituent\Model\NewEducationUnaffiliatedadditionalinformation[]|null $unaffiliatedAdditionalInformation unaffiliated_additional_information
     *
     * @return self
     */
