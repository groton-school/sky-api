...
/**
 * UpdateConstituentInteraction Class Doc Comment
 *
 * @category Class
 * @description UpdateConstituentInteraction
 * @package  SKY\Altru\Constituent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateConstituentInteraction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateConstituentInteraction';
    ...
    protected static $openAPITypes = [
        ...
        'step' => 'bool',
        'eventId' => 'string',
        'participants' => '\SKY\Altru\Constituent\Model\UpdateConstituentInteractionParticipants[]',
        'constituentId' => 'string',
        'constituentName' => 'string',
        'interactionCategory' => 'string',
        'interactionSubcategory' => 'string',
        'sites' => '\SKY\Altru\Constituent\Model\UpdateConstituentInteractionSites[]',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['objective']) && (mb_strlen($this->container['objective']) > 100)) {
            $invalidProperties[] = "invalid value for 'objective', the character length must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['objective']) && (mb_strlen($this->container['objective']) < 0)) {
     ...
     * Sets objective
     *
     * @param string|null $objective The summary.
     *
     * @return self
     */
    public function setObjective($objective)
    {
        ...
        if ((mb_strlen($objective) > 100)) {
            throw new \InvalidArgumentException('invalid length for $objective when calling UpdateConstituentInteraction., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($objective) < 0)) {
            throw new \InvalidArgumentException('invalid length for $objective when calling UpdateConstituentInteraction., must be bigger than or equal to 0.');
        }
     ...
     * Sets expectedDate
     *
     * @param \DateTime|null $expectedDate The expected date.Uses the format YYYY-MM-DD. An example date: <i>2019-11-21</i>.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The status. Available values are <i>pending</i>, <i>completed</i>, <i>canceled</i>, <i>declined</i>
     *
     * @return self
     */
     ...
     * Gets participants
     *
     * @return \SKY\Altru\Constituent\Model\UpdateConstituentInteractionParticipants[]|null
     */
     ...
     * Sets participants
     *
     * @param \SKY\Altru\Constituent\Model\UpdateConstituentInteractionParticipants[]|null $participants participants
     *
     * @return self
     */
    ...
    public function setConstituentName($constituentName)
    {
        ...
        if ((mb_strlen($constituentName) > 700)) {
            throw new \InvalidArgumentException('invalid length for $constituentName when calling UpdateConstituentInteraction., must be smaller than or equal to 700.');
        }
        if ((mb_strlen($constituentName) < 0)) {
            throw new \InvalidArgumentException('invalid length for $constituentName when calling UpdateConstituentInteraction., must be bigger than or equal to 0.');
        }
     ...
     * Gets sites
     *
     * @return \SKY\Altru\Constituent\Model\UpdateConstituentInteractionSites[]|null
     */
     ...
     * Sets sites
     *
     * @param \SKY\Altru\Constituent\Model\UpdateConstituentInteractionSites[]|null $sites sites
     *
     * @return self
     */
