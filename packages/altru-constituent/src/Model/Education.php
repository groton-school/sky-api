 ...
 */
class Education implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Education';
    ...
    protected static $openAPITypes = [
        ...
        'comment' => 'string',
        'affiliatedAdditionalInformation' => '\SKY\Altru\Constituent\Model\EducationAffiliatedadditionalinformation[]',
        'unaffiliatedAdditionalInformation' => '\SKY\Altru\Constituent\Model\EducationUnaffiliatedadditionalinformation[]',
        'affiliated' => 'bool',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['educationalInstitutionId'] === null) {
            $invalidProperties[] = "'educationalInstitutionId' can't be null";
        }
        if ($this->container['constituencyStatus'] === null) {
            $invalidProperties[] = "'constituencyStatus' can't be null";
        }
        ...
        if ($this->container['educationalHistoryStatus'] === null) {
            $invalidProperties[] = "'educationalHistoryStatus' can't be null";
        }
     ...
     *
     * @param string $educationalInstitutionId The educational institution.
     *
     * @return self
     */
     ...
     *
     * @param string $constituencyStatus The status. Available values are <i>unknown</i>, <i>currently attending</i>, <i>incomplete</i>, <i>graduated</i>
     *
     * @return self
     */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling Education., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($comment) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling Education., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \SKY\Altru\Constituent\Model\EducationAffiliatedadditionalinformation[]|null
     */
     ...
     *
     * @param \SKY\Altru\Constituent\Model\EducationAffiliatedadditionalinformation[]|null $affiliatedAdditionalInformation affiliated_additional_information
     *
     * @return self
     */
     ...
     *
     * @return \SKY\Altru\Constituent\Model\EducationUnaffiliatedadditionalinformation[]|null
     */
     ...
     *
     * @param \SKY\Altru\Constituent\Model\EducationUnaffiliatedadditionalinformation[]|null $unaffiliatedAdditionalInformation unaffiliated_additional_information
     *
     * @return self
     */
     ...
     *
     * @param string $educationalHistoryStatus The status. This simple list can be queried at https://api.sky.blackbaud.com/alt-adnmg/simplelists/086c5bfb-1a80-46cf-a2f5-05ef51120891.
     *
     * @return self
     */
