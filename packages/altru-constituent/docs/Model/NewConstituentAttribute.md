...
------------ | ------------- | ------------- | -------------
**attributeContextId** | **string** | The attribute context id. |
**headerCaption** | **string** | The headercaption. Read-only in the SOAP API. | [optional]
**attributeCategory** | **string** | The category. This simple list can be queried at https://api.sky.blackbaud.com/alt-adnmg/simplelists/958132a3-762a-4844-b7a1-f3a3098da95a?parameters&#x3D;record_type,{record_type_string}. |
...
**attributeCategories** | [**\SKY\Altru\Constituent\Model\NewConstituentAttributeAttributecategories[]**](NewConstituentAttributeAttributecategories.md) | attribute_categories | [optional]
...
**recordTypeString** | **string** | The record type. Read-only in the SOAP API. | [optional]
**currency** | **string** | The currency. This simple list can be queried at https://api.sky.blackbaud.com/alt-adnmg/simplelists/13612288-b37e-409d-ba52-6ab31637ddd6?parameters&#x3D;transaction_currency_id,{transaction_currency_id}&amp;parameters&#x3D;base_currency_id,{base_currency_id}. | [optional]
