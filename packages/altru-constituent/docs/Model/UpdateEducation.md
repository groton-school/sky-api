...
**educationalInstitutionId** | **string** | The educational institution. | [optional]
...
**constituencyStatus** | **string** | The status. Available values are &lt;i&gt;unknown&lt;/i&gt;, &lt;i&gt;currently attending&lt;/i&gt;, &lt;i&gt;incomplete&lt;/i&gt;, &lt;i&gt;graduated&lt;/i&gt; | [optional]
...
**affiliatedAdditionalInformation** | [**\SKY\Altru\Constituent\Model\UpdateEducationAffiliatedadditionalinformation[]**](UpdateEducationAffiliatedadditionalinformation.md) | affiliated_additional_information | [optional]
**unaffiliatedAdditionalInformation** | [**\SKY\Altru\Constituent\Model\UpdateEducationUnaffiliatedadditionalinformation[]**](UpdateEducationUnaffiliatedadditionalinformation.md) | unaffiliated_additional_information | [optional]
...
**educationalHistoryStatus** | **string** | The status. This simple list can be queried at https://api.sky.blackbaud.com/alt-adnmg/simplelists/086c5bfb-1a80-46cf-a2f5-05ef51120891. | [optional]
