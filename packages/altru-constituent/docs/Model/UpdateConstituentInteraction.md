...
**objective** | **string** | The summary. | [optional]
**fundraiserId** | **string** | The owner. | [optional]
**expectedDate** | **\DateTime** | The expected date.Uses the format YYYY-MM-DD. An example date: &lt;i&gt;2019-11-21&lt;/i&gt;. | [optional]
**actualDate** | **\DateTime** | The actual date.Uses the format YYYY-MM-DD. An example date: &lt;i&gt;2019-11-21&lt;/i&gt;. | [optional]
**status** | **string** | The status. Available values are &lt;i&gt;pending&lt;/i&gt;, &lt;i&gt;completed&lt;/i&gt;, &lt;i&gt;canceled&lt;/i&gt;, &lt;i&gt;declined&lt;/i&gt; | [optional]
...
**participants** | [**\SKY\Altru\Constituent\Model\UpdateConstituentInteractionParticipants[]**](UpdateConstituentInteractionParticipants.md) | participants | [optional]
...
**sites** | [**\SKY\Altru\Constituent\Model\UpdateConstituentInteractionSites[]**](UpdateConstituentInteractionSites.md) | sites | [optional]
