...
------------ | ------------- | ------------- | -------------
**organizationName** | **string** | The name. | [optional]
...
**pictureThumbnail** | **string** | The image thumbnail. | [optional]
...
**primaryAddressId** | **string** | The primary address id. | [optional]
...
**primaryPhoneId** | **string** | The primary phone id. | [optional]
...
**primaryEmailAddressId** | **string** | The primary email address id. | [optional]
