...
/**
 * NameFormatConfigurationForList Class Doc Comment
 *
 * @category Class
 * @description A record from the dbo.SALUTATION table in Raiser&#39;s Edge.
 * @package  SKY\NXT\DataIntegration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NameFormatConfigurationForList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NameFormatConfigurationForList';
    ...
    */
     ...
     * Sets example
     *
     * @param string|null $example The text example for the name format configuration field.
     *
     * @return self
     */
