...
/**
 * NameFormatConfigurationFieldCreate Class Doc Comment
 *
 * @category Class
 * @description A name format configuration represents the layout to display a constituent&#39;s name.
 * @package  SKY\NXT\DataIntegration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NameFormatConfigurationFieldCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NameFormatConfigurationFieldCreate';
