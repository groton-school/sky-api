...
/**
 * TableEntryCreate Class Doc Comment
 *
 * @category Class
 * @description An Table Entry record from the dbo.TableEntries table in Raiser&#39;s Edge.
 * @package  SKY\NXT\DataIntegration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TableEntryCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TableEntryCreate';
    ...
    */
    ...
    public function setLongDescription($longDescription)
    {
        ...
        if ((mb_strlen($longDescription) > 100)) {
            throw new \InvalidArgumentException('invalid length for $longDescription when calling TableEntryCreate., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($longDescription) < 0)) {
            throw new \InvalidArgumentException('invalid length for $longDescription when calling TableEntryCreate., must be bigger than or equal to 0.');
        }
