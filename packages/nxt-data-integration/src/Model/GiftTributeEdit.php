...
/**
 * GiftTributeEdit Class Doc Comment
 *
 * @category Class
 * @description Represents the editable properties of a Gift Tribute record in Raiser&#39;s Edge.
 * @package  SKY\NXT\DataIntegration
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GiftTributeEdit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GiftTributeEdit';
    ...
    */
    ...
    public function setAcknowledge($acknowledge)
    {
        if (is_null($acknowledge)) {
            array_push($this->openAPINullablesSetToNull, 'acknowledge');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('acknowledge', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getAcknowledgeAllowableValues();
        if (!is_null($acknowledge) && !in_array($acknowledge, $allowedValues, true)) {
