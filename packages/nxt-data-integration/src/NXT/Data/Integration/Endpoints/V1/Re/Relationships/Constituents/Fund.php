...
class Fund extends BaseEndpoint
{
     ...
     */
    public function searchByFundId(array $params): RelationshipCollection
    {
        ...
        return new RelationshipCollection($this->send("get", array_filter($params, fn($key) => in_array($key, ['fundId']), ARRAY_FILTER_USE_KEY), array_filter($params, fn($key) => in_array($key, ['limit','offset']), ARRAY_FILTER_USE_KEY)));
    }
}
