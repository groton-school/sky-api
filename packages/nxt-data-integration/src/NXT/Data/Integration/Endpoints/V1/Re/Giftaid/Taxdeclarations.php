...
class Taxdeclarations extends BaseEndpoint
{
    ...
    public function getById(array $params): GiftAidTaxDeclaration
    {
        ...
        return new GiftAidTaxDeclaration($this->send("get", array_filter($params, fn($key) => in_array($key, ['id']), ARRAY_FILTER_USE_KEY), array_filter($params, fn($key) => in_array($key, ['']), ARRAY_FILTER_USE_KEY)));
    }
    ...
    public function deleteById(array $params): GiftAidTaxDeclaration
    {
        ...
        return new GiftAidTaxDeclaration($this->send("delete", array_filter($params, fn($key) => in_array($key, ['id']), ARRAY_FILTER_USE_KEY), array_filter($params, fn($key) => in_array($key, ['']), ARRAY_FILTER_USE_KEY)));
    }
