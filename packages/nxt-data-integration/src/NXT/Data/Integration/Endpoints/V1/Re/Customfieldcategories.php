...
class Customfieldcategories extends BaseEndpoint
{
    ...
    public function getById(array $params): CustomFieldCategory
    {
        ...
        return new CustomFieldCategory($this->send("get", array_filter($params, fn($key) => in_array($key, ['id']), ARRAY_FILTER_USE_KEY), []));
    }
    ...
    public function list_(array $params): CustomFieldCategoryCollection
    {
        ...
        return new CustomFieldCategoryCollection($this->send("get", [], array_filter($params, fn($key) => in_array($key, ['record_type','include_inactive','limit','offset']), ARRAY_FILTER_USE_KEY)));
    }
