...
class Users extends BaseEndpoint
{
    ...
    public function getById(array $params): User
    {
        ...
        return new User($this->send("get", array_filter($params, fn($key) => in_array($key, ['id']), ARRAY_FILTER_USE_KEY), array_filter($params, fn($key) => in_array($key, ['']), ARRAY_FILTER_USE_KEY)));
    }
}
