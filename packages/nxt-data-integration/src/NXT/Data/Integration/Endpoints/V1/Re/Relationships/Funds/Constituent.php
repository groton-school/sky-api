...
class Constituent extends BaseEndpoint
{
     ...
     */
    public function searchByConstituentId(array $params): RelationshipCollection
    {
        ...
        return new RelationshipCollection($this->send("get", array_filter($params, fn($key) => in_array($key, ['constituentId']), ARRAY_FILTER_USE_KEY), array_filter($params, fn($key) => in_array($key, ['limit','offset']), ARRAY_FILTER_USE_KEY)));
    }
}
