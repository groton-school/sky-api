 ...
 * @property ?int $tax_payer_status_id
 * @property ?int $declaration_indicator_id
 * @property ?int $declaration_source_id
 ...
 * @api
 */
class GiftAidTaxDeclaration extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "declaration_id" => "int",
        "constituent_id" => "int",
        "tax_payer_status_id" => "int",
        "declaration_indicator_id" => "int",
        "declaration_source_id" => "int",
        "import_id" => "string",
