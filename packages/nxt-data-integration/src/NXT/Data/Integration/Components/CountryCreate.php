...
/**
 * RE7 Country record create class from the dbo.COUNTRY\_CODES table in
 * Raiser's Edge.
 *
 ...
 *   country. Default to UK format as it is the most flexible
 *
 * @api
 */
class CountryCreate extends BaseComponent
{
    /**
     * @var string[] $fields
     */
