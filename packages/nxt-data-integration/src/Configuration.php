...
namespace SKY\NXT\DataIntegration;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.sky.blackbaud.com/nxt-data-integration';
    ...
    {
        $report  = 'PHP SDK (SKY\NXT\DataIntegration) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.sky.blackbaud.com/nxt-data-integration",
