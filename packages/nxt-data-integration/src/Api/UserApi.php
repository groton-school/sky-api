...
class UserApi
{
     ...
     *
     * @param  int $id Format - int32. The system ID of the user. (required)
     ...
     * @return \SKY\NXT\DataIntegration\Model\User
     */
     ...
     * @throws \SKY\NXT\DataIntegration\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \SKY\NXT\DataIntegration\Model\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserWithHttpInfo($id, string $contentType = self::contentTypes['getUser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SKY\NXT\DataIntegration\Model\User' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SKY\NXT\DataIntegration\Model\User' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SKY\NXT\DataIntegration\Model\User', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
            }

            $returnType = '\SKY\NXT\DataIntegration\Model\User';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SKY\NXT\DataIntegration\Model\User',
