...
------------ | ------------- | ------------- | -------------
**fundCategory** | **string** | The fund category. | [optional]
**fundType** | **string** | The fund type. | [optional]
**campaign** | **string** | The campaign associated with the fund. | [optional]
**defaultAppeal** | **string** | The default appeal associated with the fund. | [optional]
**id** | **int** | The immutable system record ID of the fund. | [optional]
