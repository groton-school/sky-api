...
class V1 extends BaseEndpoint
{
    ...
    /**
     * @var \Blackbaud\SKY\School\Endpoints\V1\Users $_users Routing class for
     *   the subnamespace `Users`
     */
    ...
    /**
     * @var \Blackbaud\SKY\School\Endpoints\V1\Lists $_lists Routing class for
     *   the subnamespace `Lists`
     */
    ...
    /**
     * @var \Blackbaud\SKY\School\Endpoints\V1\Testscores $_testscores Routing
     *   class for the subnamespace `Testscores`
     */
