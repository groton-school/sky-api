...
/**
 * AdvisoriesApi Class Doc Comment
 *
 * @category Class
 * @package  SKY\School
 * @author   OpenAPI Generator team
...
class AdvisoriesApi
{
    ...
    /**
     * Operation v1AdvisoriesSectionsGet
     *
    ...
    /**
     * Operation v1AdvisoriesSectionsGetWithHttpInfo
     *
     * Advisories sections by school level
     *
     * @param  int $level_num Format - int32. Level number (required)
    ...
    public function v1AdvisoriesSectionsGetWithHttpInfo($level_num, $school_year = null, string $contentType = self::contentTypes['v1AdvisoriesSectionsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\SKY\School\Model\AdvisoriesSectionCollection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SKY\School\Model\AdvisoriesSectionCollection' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SKY\School\Model\AdvisoriesSectionCollection', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SKY\School\Model\AdvisoriesSectionCollection',
    ...
    /**
     * Operation v1AdvisoriesSectionsGetAsync
     *
     * Advisories sections by school level
     *
     * @param  int $level_num Format - int32. Level number (required)
    ...
    /**
     * Operation v1AdvisoriesSectionsGetAsyncWithHttpInfo
     *
     * Advisories sections by school level
     *
     * @param  int $level_num Format - int32. Level number (required)
    ...
    public function v1AdvisoriesSectionsGetRequest($level_num, $school_year = null, string $contentType = self::contentTypes['v1AdvisoriesSectionsGet'][0])
    {
        ...
        $resourcePath = '/v1/advisories/sections';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
