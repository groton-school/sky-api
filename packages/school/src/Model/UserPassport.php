...
/**
 * UserPassport Class Doc Comment
 *
 * @category Class
 ...
 */
class UserPassport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserPassport';
    ...
    */
     ...
     * Sets number
     *
     * @param string|null $number The passport number of the user.
     *
     * @return self
     */
