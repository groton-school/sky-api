...
class Category implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The Id of the news category
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the news category
     *
     * @return self
     */
     ...
     * Sets primary
     *
     * @param bool|null $primary Set to true if the new category is the primary source of the news item
     *
     * @return self
     */
