 ...
 */
class Coach implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Coach';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID of the coach
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title Coach's title
     *
     * @return self
     */
