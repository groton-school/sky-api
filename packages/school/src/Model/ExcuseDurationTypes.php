...
/**
 * ExcuseDurationTypes Class Doc Comment
 *
 * @category Class
 * @description
 * @package  SKY\School
 ...
 */
class ExcuseDurationTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExcuseDurationTypes';
    ...
    */
    ...
    {
        return $this->container['na'];
    }

    /**
     * Sets na
     *
     * @param int|null $na Not Applicable
     *
     * @return self
     */
    ...
    {
        if (is_null($na)) {
            throw new \InvalidArgumentException('non-nullable na cannot be null');
        }
        $this->container['na'] = $na;
