 ...
 */
class PhoneShare implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhoneShare';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the phone number to be shared with the user
     *
     * @return self
     */
