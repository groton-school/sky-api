...
/**
 * PhoneTypeLink Class Doc Comment
 *
 * @category Class
 ...
 */
class PhoneTypeLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhoneTypeLink';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The type ID of a phone number; the type ID corresponds with the type of phone number (ex. Cell, Work, Home)
     *
     * @return self
     */
     ...
     * Sets shared
     *
     * @param bool|null $shared Returns true if changes to a phone number are made to all users with a shared relationship (Read Only)
     *
     * @return self
     */
     ...
     * Sets type_id
     *
     * @param string|null $type_id The name of the type
     *
     * @return self
     */
