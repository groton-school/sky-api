...
/**
 * DepartmentCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class DepartmentCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DepartmentCollection';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'next_link' => 'string',
        'value' => '\SKY\School\Model\Department[]',
    ];
    ...
    */
     ...
     * Sets value
     *
     * @param \SKY\School\Model\Department[]|null $value The set of items included in the response. This may be a subset of the items in the collection
     *
     * @return self
     */
