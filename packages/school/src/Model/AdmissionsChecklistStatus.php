...
/**
 * AdmissionsChecklistStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class AdmissionsChecklistStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdmissionsChecklistStatus';
    ...
    */
     ...
     * Sets ordinal
     *
     * @param int|null $ordinal Order of the status (lower items are earlier in the order)
     *
     * @return self
     */
    ...
    {
        if (is_null($ordinal)) {
            array_push($this->openAPINullablesSetToNull, 'ordinal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ordinal', $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
