 ...
 */
class UserVisa implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserVisa';
    ...
    protected static $openAPITypes = [
        'number' => 'string',
        'status' => '\SKY\School\Model\IdDescriptorField',
        'type' => '\SKY\School\Model\IdDescriptorField',
        'issue_date' => '\DateTime',
    ...
    */
     ...
     * Sets number
     *
     * @param string|null $number The number of the user visa.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \SKY\School\Model\IdDescriptorField|null $status status
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \SKY\School\Model\IdDescriptorField|null $type type
     *
     * @return self
     */
     ...
     * Sets issue_date
     *
     * @param \DateTime|null $issue_date The issue date of the user visa.
     *
     * @return self
     */
     ...
     * Sets expire_date
     *
     * @param \DateTime|null $expire_date The expire date of the user visa.
     *
     * @return self
     */
