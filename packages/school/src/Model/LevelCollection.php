...
/**
 * LevelCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class LevelCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LevelCollection';
    ...
    */
     ...
     * Sets value
     *
     * @param \SKY\School\Model\Level[]|null $value The set of items included in the response. This may be a subset of the items in the collection
     *
     * @return self
     */
