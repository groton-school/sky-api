...
/**
 * AddressShare Class Doc Comment
 *
 * @category Class
 * @description
 * @package  SKY\School
 ...
 */
class AddressShare implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressShare';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the address to be shared with the user
     *
     * @return self
     */
