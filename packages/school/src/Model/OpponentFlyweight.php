...
/**
 * OpponentFlyweight Class Doc Comment
 *
 * @category Class
 * @description
 * @package  SKY\School
 ...
 */
class OpponentFlyweight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpponentFlyweight';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID ofthe opponent
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the opponent
     *
     * @return self
     */
