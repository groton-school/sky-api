 ...
 */
class Opponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Opponent';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Opponents team ID
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Opponents team name
     *
     * @return self
     */
     ...
     * Sets score
     *
     * @param string|null $score The final score of the game.
     *
     * @return self
     */
