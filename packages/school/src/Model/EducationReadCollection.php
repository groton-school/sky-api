...
/**
 * EducationReadCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class EducationReadCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EducationReadCollection';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'next_link' => 'string',
        'value' => '\SKY\School\Model\EducationRead[]',
    ];
    ...
    */
     ...
     * Sets value
     *
     * @param \SKY\School\Model\EducationRead[]|null $value The set of items included in the response. This may be a subset of the items in the collection
     *
     * @return self
     */
