...
/**
 * PracticeCreate Class Doc Comment
 *
 * @category Class
 * @description
 * @package  SKY\School
 ...
 */
class PracticeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PracticeCreate';
    ...
    */
     ...
     * Sets title
     *
     * @param string|null $title Title of the practice
     *
     * @return self
     */
