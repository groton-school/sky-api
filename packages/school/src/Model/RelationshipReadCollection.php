...
/**
 * RelationshipReadCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class RelationshipReadCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelationshipReadCollection';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'next_link' => 'string',
        'value' => '\SKY\School\Model\RelationshipRead[]',
    ];
    ...
    */
     ...
     * Sets value
     *
     * @param \SKY\School\Model\RelationshipRead[]|null $value The set of items included in the response. This may be a subset of the items in the collection
     *
     * @return self
     */
