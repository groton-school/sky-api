...
/**
 * AdmissionsStatuses Class Doc Comment
 *
 * @category Class
 ...
 */
class AdmissionsStatuses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdmissionsStatuses';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Identifier for a given status
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Name of the status
     *
     * @return self
     */
