...
/**
 * GradeLevelCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class GradeLevelCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GradeLevelCollection';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'next_link' => 'string',
        'value' => '\SKY\School\Model\GradeLevel[]',
    ];
    ...
    */
     ...
     * Sets value
     *
     * @param \SKY\School\Model\GradeLevel[]|null $value The set of items included in the response. This may be a subset of the items in the collection
     *
     * @return self
     */
