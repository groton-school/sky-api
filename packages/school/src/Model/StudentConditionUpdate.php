...
/**
 * StudentConditionUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class StudentConditionUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StudentConditionUpdate';
    ...
    */
     ...
     * Sets medications
     *
     * @param int[]|null $medications The list of student medication IDs for the condition. If included, this list will replace the existing list of medications.
     *
     * @return self
     */
