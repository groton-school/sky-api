...
/**
 * MedicationDosageCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class MedicationDosageCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MedicationDosageCreate';
    ...
    */
     ...
     * Sets times_a_day
     *
     * @param int|null $times_a_day The times per day to dispense the medication
     *
     * @return self
     */
     ...
     * Sets frequency
     *
     * @param string $frequency The weekly frequency to dispense the medication. Allowed values: every day, as needed, specific days.
     *
     * @return self
     */
