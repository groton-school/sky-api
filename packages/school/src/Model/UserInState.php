 ...
 */
class UserInState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserInState';
    ...
    */
     ...
     * Sets resident
     *
     * @param string|null $resident The value the user has selected for In-State Resident. Allowed values: Yes, No, or No answer.
     *
     * @return self
     */
    ...
    {
        if (is_null($resident)) {
            array_push($this->openAPINullablesSetToNull, 'resident');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('resident', $nullablesSetToNull);
            if ($index !== false) {
     ...
     * Sets county
     *
     * @param string|null $county The county of residence of the user.
     *
     * @return self
     */
