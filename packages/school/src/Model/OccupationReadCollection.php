...
/**
 * OccupationReadCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class OccupationReadCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OccupationReadCollection';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'next_link' => 'string',
        'value' => '\SKY\School\Model\OccupationRead[]',
    ];
    ...
    */
     ...
     * Sets value
     *
     * @param \SKY\School\Model\OccupationRead[]|null $value The set of items included in the response. This may be a subset of the items in the collection
     *
     * @return self
     */
