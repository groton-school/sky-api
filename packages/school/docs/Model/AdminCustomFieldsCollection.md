...
**value** | [**\SKY\School\Model\AdminCustomFields[]**](AdminCustomFields.md) | The set of items included in the response. This may be a subset of the items in the collection | [optional]
