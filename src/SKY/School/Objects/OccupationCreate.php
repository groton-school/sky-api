 ...
 *   field
 * @property bool | null $matching_gift Indicates if employer matches employee
 *   donations
 ...
 *   employee
 * @property int | null $years_employed Number of years employee has been at
 *   this business
 * @property bool | null $current Indicates if this is the individuals current
 *   employer
 *
 * @api
 */
...
{
    /** @var string[] $fields */
    protected static array $fields = ["business_name","job_title","business_url","industry","organization","occupation","matching_gift","begin_date","end_date","specialty","parent_company","job_function","years_employed","current"];
}
