 ...
 *
 * @property GrotonSchool\Blackbaud\SKY\School\Objects\Advisor[] | null
 *   $advisors The list of teachers for this section
 ...
 * @api
 */
class AdvisoriesSection extends BaseObject
{
    /** @var string[] $fields */
    protected static array $fields = ["advisors","id","course_code","duration","lead_section_id","name","offering_id","parent_section_id","room_id","school_year","section_identifier"];
}
