 ...
 * @property GrotonSchool\Blackbaud\SKY\School\Objects\UserDegreeOutputModel[]
 *   | null $value The set of items included in the response. This may be a
 *   subset of the items in the collection
 *
 * @api
 */
class UserDegreeOutputModelCollection extends BaseObject
{
    /** @var string[] $fields */
