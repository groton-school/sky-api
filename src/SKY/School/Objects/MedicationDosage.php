 ...
 * @property string | null $frequency The frequency of the medication
 *   Daily/Specific days/ Custom
 * @property \GrotonSchool\Blackbaud\SKY\School\Objects\Days $days Days for
 *   medication
 *
 * @api
 */
