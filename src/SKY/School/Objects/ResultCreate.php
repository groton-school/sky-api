 ...
 * @property int $schedule_type Set to 0 for Versus scoring results <br />
 *   Set to 1 for Place/Points scoring results
 * @property bool $send_notification Toggle to true to send a notification of
 *   this event change
 * @property GrotonSchool\Blackbaud\SKY\School\Objects\ResultCreateOpponent[]
 *   | null $opponents List of opponents to record results for
 *
 * @api
 */
