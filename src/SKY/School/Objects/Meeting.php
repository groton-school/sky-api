 ...
 * @property string | null $group_name The auto generated name of the group
 ...
 * @property string | null $room_name The name of the room where the meeting
 *   takes place
 * @property int $room_number The room number where the meeting takes place
 * @property int $room_capacity The room capacity
 * @property string | null $room_code The room code
 * @property int $faculty_user_id The user id of the faculty member
 * @property string | null $faculty_name The combined name of the head faculty
 *   member
 * @property string | null $faculty_firstname The faculty member's first name
 * @property string | null $faculty_lastname The faculty member's last name
 ...
 *   $teachers The list of teachers for the meeting
 *
 * @api
 */
