 ...
 *   null $home_languages A list of languages. Each entry is the descriptor or
 *   ID of the language. Descriptors are not case sensitive, but otherwise
 *   must match the table value exactly. These values are returned by GET
 *   Types table values.
 ...
 *   $races A list of races. Each entry is the descriptor or ID of the race.
 *   Descriptors are not case sensitive, but otherwise must match the table
 *   value exactly. These values are returned by GET Types table values.
 ...
 * @property string[] | null $fields_to_delete An array of strings
