 ...
 * @property \Blackbaud\SKY\School\Objects\MediaItem[] $media_item
 * @property \Blackbaud\SKY\School\Objects\Category[] $categories The list of
 *   categories the news item is published to
 *
 * @api
 */
