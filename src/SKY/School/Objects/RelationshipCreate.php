 ...
 * @property bool | null $give_parental_access Toggles 'Give Parental Access'
 *   option.
 * @property bool | null $list_as_parent Toggles 'List as a Parent' option.
 * @property bool | null $tuition_responsible_signer Toggles 'Responsible for
