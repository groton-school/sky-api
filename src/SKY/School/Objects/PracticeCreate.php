 ...
 * @property string | null $title Title of the practice
...
{
    /** @var string[] $fields */
    protected static array $fields = ["send_notification","title","practice_start_date","practice_end_date","location_id","room_id","transportation_id","dismissal_time","departure_time","pickup_time","practice_note","skip_validation"];
}
