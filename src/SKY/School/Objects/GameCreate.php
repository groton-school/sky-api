 ...
 * @property string $game_date Date and time of the game <br />
 ...
 *   <br />
 * @property int | null $cancel_type Defaults to 0 for a new game
 * @property int | null $home_away_type Set to 0 for Home <br />
 *   Set to 1 for Away <br />
 * @property int | null $location_id ID of the location/venue for the game
 * @property int | null $location_ind For Home games (location_ind=0), the
 *   ```location_id``` is an ID for an athletic field or room/building. Both
 *   of these are returned by GET Athletics venues.<br />
