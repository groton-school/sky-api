 ...
 *   event
 * @property \Blackbaud\SKY\School\Objects\GameTransportation[]
 *   $transportation List of the transportation to be used for this game
 * @property \Blackbaud\SKY\School\Objects\GameOpponent[] $opponents List of
 *   Opponent ID's involved in this game
 *
 * @api
 */
