 ...
 * @property string $block_name The name of the block the section is scheduled
 *   in
 * @property int $room_id The Id of the room the section takes place in
 * @property string $room_name The name of the room the section takes place in
 ...
 *   place in
 * @property string $room_code The code of the room the section takes place in
 ...
 * @property \Blackbaud\SKY\School\Objects\OfferingType $offering_type
 *   OfferingType Model
 *
 * @api
 */
