 ...
 * @property \Blackbaud\SKY\School\Objects\AddressExRead[] $addresses List of
 *   the user addresses
 ...
 * @property string $boarding_or_day The 'Boarding Or Day' status of the user.
 *   'B' for boarding and 'D' for day, or will be a blank string if not set.
 ...
 * @property string $deceased_date The deceased date in the user profile; Uses
 *   [ISO-8601](https://tools.ietf.org/html/rfc3339) (24H) format:
 *   2003-04-21T10:29:43
 ...
 * @property \Blackbaud\SKY\School\Objects\EducationRead[] $education List of
 *   the user educational institutions
 ...
 * @property \Blackbaud\SKY\School\Objects\HomeLanguageRead[] $home_languages
 *   List of user home languages
 ...
 *   profile
 * @property \Blackbaud\SKY\School\Objects\UserInState $in_state An object for
 *   in-state resident information
 ...
 * @property string $last_sync_date The last sync date of a user profile; Uses
 *   [ISO-8601](https://tools.ietf.org/html/rfc3339) (24H) format:
 *   2003-04-21T10:29:43
 ...
 * @property \Blackbaud\SKY\School\Objects\UserLocker $locker An object for
 *   locker information
 * @property string $maiden_name The maiden name of a user
 * @property \Blackbaud\SKY\School\Objects\UserMailbox $mailbox An object for
 *   mailbox information
 ...
 * @property \Blackbaud\SKY\School\Objects\OccupationRead[] $occupations List
 *   of the users occupations
 * @property \Blackbaud\SKY\School\Objects\UserPassport $passport An object
 *   for passport information
 * @property string $personal_bio The personal bio from the user profile
 * @property string $personal_website The personal website in the user profile
 * @property \Blackbaud\SKY\School\Objects\PhoneRead[] $phones List of the
 *   user phone numbers
 ...
 *   profile.
 * @property \Blackbaud\SKY\School\Objects\UserProfilePhoto $profile_photo
 ...
 * @property \Blackbaud\SKY\School\Objects\RaceRead[] $races List of the races
 *   object for the user profile.
 * @property \Blackbaud\SKY\School\Objects\RelationshipRead[] $relationships
 *   List of the user relationships
 ...
 *   [ISO-8601](https://tools.ietf.org/html/rfc3339) (24H) format:
 *   2003-04-21T10:29:43
 * @property \Blackbaud\SKY\School\Objects\Role[] $roles List of the user
 *   roles
 ...
 * @property \Blackbaud\SKY\School\Objects\StudentInfo $student_info
 *   StudentInfo Model
 * @property string $suffix The suffix of a user
 * @property string $username The username used to access the system
 * @property \Blackbaud\SKY\School\Objects\UserVisa $visa An object for visa
 *   information
 *
 * @api
 */
