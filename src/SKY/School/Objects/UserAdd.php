 ...
 * @property \Blackbaud\SKY\School\Objects\HomeLanguageAdd[] $home_languages A
 *   list of languages the user speaks at home. Each entry is the description or
 *   ID of the language. Descriptors are not case sensitive, but otherwise must
 *   match the table value exactly. These values are returned by GET Types table
 *   values.
 ...
 *   Descriptors are not case sensitive, but otherwise must match the table
 *   value exactly. These values are returned by GET Types table values.
 * @property \Blackbaud\SKY\School\Objects\UserAddRace[] $races A list of
 ...
 * @property \Blackbaud\SKY\School\Objects\UserVisaAdd $visa An object for
 *   visa information
 *
 * @api
 */
