 ...
 *
 * @property ?\Blackbaud\SKY\School\Components\Advisor[] $advisors The list of
 ...
 * @api
 */
class AdvisoriesSection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "advisors" => "\Blackbaud\SKY\School\Components\Advisor[]",
        "id" => "int",
        "course_code" => "string",
