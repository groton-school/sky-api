 ...
 *   page of results
 * @property ?\Blackbaud\SKY\School\Components\Player[] $value The set of
 *   items included in the response. This may be a subset of the items in the
 *   collection
 *
 * @api
 */
class PlayerCollection extends BaseComponent
{
    /**
     * @var string[] $fields
     */
    protected static array $fields = [
        "count" => "int",
        "next_link" => "string",
        "value" => "\Blackbaud\SKY\School\Components\Player[]",
    ];
}
