...
class Sections extends BaseEndpoint
{
     ...
     * @param ?string $school_year The school year to get activity sections
     *   for.
     ...
     */
    public function filterBy(int $level_num, ?string $school_year): ActivitiesSectionCollection
    {
